        ...
        {step === 'input' && (
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold dark:text-white font-sans">Guided Intake</h2>
                <p className="text-xs text-slate-400">Step 1 of 3: Describe what you are experiencing</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center text-[10px] text-slate-400 font-semibold mb-2">
                <span className="uppercase tracking-wider">Clinical Follow-up</span>
